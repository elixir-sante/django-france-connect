"""
Django settings for djangofranceconnect project.
...
SECRET_KEY = 'vd1z&(nzf!qo=ob9e6spr2=$tdnss^tx*nk%kv=&d1s#8=f*4t'
...
INSTALLED_APPS = [
    ...
    'django_extensions',
    'djangofranceconnect.franceconnect',
]
...
ROOT_URLCONF = 'djangofranceconnect.urls'
...
WSGI_APPLICATION = 'djangofranceconnect.wsgi.application'
